...
.\chrome.exe --new-window --kiosk https://google.com --window-position=0,0
.\chrome.exe --new-window --kiosk https://nu.nl --window-position=1920,0
# .\chrome.exe --new-window --kiosk https://google.com --window-position=3840,0
